...
#
# This "-vanillaqt" variant exists because I can't get the regular octave-octapp@8.3.0 with
...
class OctaveOctappVanillaqtAT830 < Formula
  desc "GNU Octave, customized for Octave.app, but using vanilla Qt, v. 8.3.0"
