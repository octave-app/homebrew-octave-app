class Python3720 < Formula
  ...
  depends_on "openssl_1.0.2q_0"
  depends_on "readline_7.0.5_0"
  depends_on "sqlite_3.26.0_0"
  ...
  def install
    ...
    args = %W[
      ...
      --without-ensurepip
      --with-dtrace
      --with-openssl=#{Formula["openssl_1.0.2q_0"].opt_prefix}
    ]
    ...
    inreplace "setup.py" do |s|
      ...
      s.gsub! "for d_ in inc_dirs + sqlite_inc_paths:",
              "for d_ in ['#{Formula["sqlite_3.26.0_0"].opt_include}']:"
    end
  ...
  def post_install
    ...
    include_dirs = [HOMEBREW_PREFIX/"include", Formula["openssl_1.0.2q_0"].opt_include,
                    Formula["sqlite_3.26.0_0"].opt_include]
    library_dirs = [HOMEBREW_PREFIX/"lib", Formula["openssl_1.0.2q_0"].opt_lib,
                    Formula["sqlite_3.26.0_0"].opt_lib]
