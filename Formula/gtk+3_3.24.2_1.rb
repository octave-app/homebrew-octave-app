class Gtkx332421 < Formula
  ...
  depends_on "gsettings-desktop-schemas_3.28.1_0"
  ...
  def post_install
    system "#{Formula["glib_2.58.2_0"].opt_bin}/glib-compile-schemas", "#{HOMEBREW_PREFIX}/share/glib-2.0/schemas"
  end
