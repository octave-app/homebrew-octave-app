...
class OctaveOctappQt512 < Formula
  desc "GNU Octave, customized for Octave.app, but with Qt 5.12"
  ...
  def post_install
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-octapp-qt512"
  end
