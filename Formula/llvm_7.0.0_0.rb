class Llvm7000 < Formula
  ...
  def install
    ...
    if build.with? "python@2"
      ENV.prepend_path "PATH", Formula["python_2.7.15_1"].opt_libexec/"bin"
    end
    ...
    args = %W[
      ...
      -DWITH_POLLY=ON
      -DFFI_INCLUDE_DIR=#{Formula["libffi_3.2.1_0"].opt_lib}/libffi-#{Formula["libffi_3.2.1_0"].version}/include
      -DFFI_LIBRARY_DIR=#{Formula["libffi_3.2.1_0"].opt_lib}
    ]
