class Python22715 < Formula
  ...
  depends_on "sphinx-doc_1.7.5" => :build if MacOS.version > :snow_leopard
  depends_on "gdbm_1.16"
  ...
  def install
    ...
    inreplace "setup.py" do |s|
      s.gsub! "do_readline = self.compiler.find_library_file(lib_dirs, 'readline')",
              "do_readline = '#{Formula["readline_7.0.5"].opt_lib}/libhistory.dylib'"
      s.gsub! "/usr/local/ssl", Formula["openssl_1.0.2o"].opt_prefix
    end
