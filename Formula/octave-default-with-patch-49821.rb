...
class OctaveDefaultWithPatch49821 < Formula
  ...
  # Fix bug #59128: Bad default font on macOS 10.15
  patch do
    url "https://savannah.gnu.org/bugs/download.php?file_id=49821"
    sha256 "3850940013946d1328e040a0420a2c3607176cefc3f92a6b47128cbb5b4205a6"
  end
