# GNU Octave 9.1.90 (RC for 9.2.0)
...
class OctaveAT9190 < Formula
  desc "High-level interpreted language for numerical computing"
  homepage "https://www.gnu.org/software/octave/index.html"
  url "https://alpha.gnu.org/gnu/octave/octave-9.1.90.tar.xz"
  sha256 "3974911cb376a1c997dac0b63c2d6cb9b45733a6aba3c41b6960257759408608"
  ...
  def post_install
    ...
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave@9.1.90"
  end
