...
# development code from the Octave repo, with extra patches.
...
class OctaveDefaultWithImplicitConversions < Formula
  ...
  if build.with?("qt")
    ...
    # Add implicit conversion for arbitrary classes to numeric types
    patch do
      url "https://bpaste.net/raw/cc2499b61ce6"
      sha256 "9dc2911fb0910402fc0d8fa9322b4cc72267ac5183169c9530cc77160981ab3e"
    end
  end
