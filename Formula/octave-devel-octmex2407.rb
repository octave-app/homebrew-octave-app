# GNU Octave, head (9.2+) with liboctmex patch
#
# This is a temporary-use debugging formula, to figure out the issue discussed here on the
# Octave Discourse:
#   https://octave.discourse.group/t/add-library-liboctmex-for-mex-interface-c-api/5732
#
...
class OctaveDevelOctmex2407 < Formula
  ...
  def post_install
    ...
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-devel-octmex2407"
  end
