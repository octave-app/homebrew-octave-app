# GNU Octave 9.1.0, with Qt 5 not 6
#
...
class OctaveQt5AT910 < Formula
  desc "High-level interpreted language for numerical computing, v. 9.1.0, with Qt 5 (not Qt 6)"
  ...
  def post_install
    ...
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-qt5@9.1.0"
  end
