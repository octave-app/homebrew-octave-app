class PythonAT2@2715 < Formula
  ...
  depends_on "sphinx-doc@1.7.5" => :build if MacOS.version > :snow_leopard
  depends_on "gdbm@1.14.1"
  depends_on "openssl@1.0.2o"
  depends_on "readline@7.0.3"
  depends_on "sqlite@3.24.0"
  depends_on "tcl-tk@8.6.8" => :optional
