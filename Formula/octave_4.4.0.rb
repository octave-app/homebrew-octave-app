...
class Octave440 < Formula
  ...
  def install
    ...
    if build.without?("docs") && build.with?("qt") && !build.stable?
      ...
      system "#{Formula["qt_5.11.1"].opt_bin}/qcollectiongenerator", "doc/octave_interpreter.qhcp", "-o", "doc/octave_interpreter.qhc"
