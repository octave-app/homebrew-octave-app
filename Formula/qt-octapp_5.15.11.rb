# Qt 5.15.11, hacked for Octave.app
#
# This formula is named qt-octapp_5.15.11 instead of qt-octapp@5.15.11 because having an "@" in the formula
# name causes a ninja build error.
#
# We're retaining 5.15.11 as a separate formula because I'm having trouble getting
# 5.15.13 and later to build (and even 5.15.12 in its revised formula), so keeping
# this 5.15.11 formula around as a reference. This 5.15.11 version is based on the
# core Homebrew qt@5 formula from commit c3d26e1fa when it was bumped to 5.15.11;
# I checked and there were no sig changes to it until the 5.15.12 bump.

class QtOctapp51511 < Formula
  desc "Cross-platform application and UI framework, 5.15.11 version, Octave.app-hacked"
  ...
  resource "qtwebengine" do
    ...
    # octapp: patch from newer formula, may be needed for old 5.15.11 with newer Xcode
