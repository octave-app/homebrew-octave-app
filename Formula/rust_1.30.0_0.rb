class Rust13000 < Formula
  ...
  def install
    ...
    ENV["OPENSSL_DIR"] = Formula["openssl_1.0.2p_0"].opt_prefix
    ...
    args << "--llvm-root=#{Formula["llvm_7.0.0_0"].opt_prefix}" if build.with? "llvm"
    if build.head?
