class Librsvg244110 < Formula
  ...
  def post_install
    ...
    system "#{Formula["gdk-pixbuf_2.38.0_0"].opt_bin}/gdk-pixbuf-query-loaders", "--update-cache"
  end
  ...
  test do
    ...
    EOS
    cairo = Formula["cairo_1.16.0_0"]
    fontconfig = Formula["fontconfig"]
    freetype = Formula["freetype"]
    gdk_pixbuf = Formula["gdk-pixbuf_2.38.0_0"]
    gettext = Formula["gettext"]
    glib = Formula["glib_2.58.2_0"]
