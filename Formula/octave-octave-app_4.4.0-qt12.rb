# GNU Octave, Qt-enabled, against Qt 5.12, with build customized for Octave.app
...
class OctaveOctaveApp440Qt12 < Formula
  desc "High-level interpreted language for numerical computing"
  homepage "https://www.gnu.org/software/octave/index.html"
  url "ftp://ftp.gnu.org/gnu/octave/octave-4.4.0.tar.gz"
  sha256 "72f846379fcec7e813d46adcbacd069d72c4f4d8f6003bcd92c3513aafcd6e96"

  keg_only "This is a non-standard variant of Octave"
  ...
  option "with-test", "Skip compile-time make checks (not recommended)"
  ...
  depends_on "gnuplot-octave-app_5.2.4_0-qt12"
  ...
  if build.with?("qt")
    ...
    depends_on "qscintilla2-octave-app_2.10.4-qt12"
  ...
  def install
    ...
    ENV.append "CXXFLAGS", "-I#{Formula["qscintilla2-octave-app_2.10.4-qt12"].opt_include}"
    ENV.append "LDFLAGS", "-L#{Formula["qscintilla2-octave-app_2.10.4-qt12"].opt_lib}"
    ...
    if build.without?("docs") && build.with?("qt") && !build.stable?
      ...
      system "#{Formula["qt_5.12.0_0"].opt_bin}/qcollectiongenerator", "doc/octave_interpreter.qhcp", "-o", "doc/octave_interpreter.qhc"
