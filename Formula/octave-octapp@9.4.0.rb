# GNU Octave 9.4.0, with build customized for Octave.app
...
class OctaveOctappAT940 < Formula
  desc "GNU Octave, customized for Octave.app, v. 9.4.0"
  ...
  def post_install
    ...
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-octapp@9.4.0"
  end
