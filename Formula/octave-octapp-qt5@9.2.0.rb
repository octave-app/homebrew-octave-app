# GNU Octave 9.2.0, with Qt 5, with build customized for Octave.app
...
class OctaveOctappQt5AT920 < Formula
  desc "GNU Octave, customized for Octave.app, v. 9.2.0, with Qt 5"
  ...
  def install
    ...
    if build.without?("docs") && !build.stable?
  ...
  def post_install
    ...
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-octapp-qt5@9.2.0"
  end
