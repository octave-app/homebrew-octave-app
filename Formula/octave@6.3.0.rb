# GNU Octave 6.3.0, Qt-enabled, with macOS patches, but not Octave.app customizations
...
class OctaveAT630 < Formula
  ...
  def post_install
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-6.3.0"
  end
