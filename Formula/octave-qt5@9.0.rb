# GNU Octave 9.0 (currently prerelease), with Qt 5 not 6, with macOS patches, but not Octave.app customizations
#
...
class OctaveQt5AT90 < Formula
  ...
  def post_install
    ...
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-qt5@9.0"
  end
