# GNU Octave 6.3.0, Qt-enabled, with build customized for Octave.app
...
class OctaveOctappAT630 < Formula
  desc "GNU Octave, customized for Octave.app, v. 6.3.0"
  ...
  def post_install
    ...
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave-octapp-6.3.0"
  end
