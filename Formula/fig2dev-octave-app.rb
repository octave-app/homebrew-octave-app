...
# instead of netpbm, so we can get it building on macOS 10.12. Now that we've dropped support for macOS versions < 11, can probably
# remove this and use regular fig2dev instead.
