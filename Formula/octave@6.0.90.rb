# GNU Octave 6.0.90 Release Candidate, Qt-enabled, with macOS patches, but not Octave.app customizations
#
...
class OctaveAT6090 < Formula
  ...
  # No longer applies as of Octave 6.0.x
  #patch do
  ...
  def post_install
    system "ln", "-sf", "#{bin}/octave", "#{HOMEBREW_PREFIX}/bin/octave@5.2.0"
  end
