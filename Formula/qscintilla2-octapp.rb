...
#
# The octapp hacks are: make sip a regular dependency instead of :build only.
#
# TODO: This formula may not be necessary at all, because we don't have an
# octapp-hacked version of qt for Qt 6.
