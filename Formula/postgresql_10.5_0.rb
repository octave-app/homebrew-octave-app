class Postgresql1050 < Formula
  ...
  def install
    ...
    ENV.prepend "LDFLAGS", "-L#{Formula["openssl_1.0.2p_0"].opt_lib} -L#{Formula["readline_7.0.5_0"].opt_lib}"
    ENV.prepend "CPPFLAGS", "-I#{Formula["openssl_1.0.2p_0"].opt_include} -I#{Formula["readline_7.0.5_0"].opt_include}"
